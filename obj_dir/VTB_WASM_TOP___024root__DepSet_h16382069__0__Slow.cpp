...
VL_ATTR_COLD void VTB_WASM_TOP___024root___ctor_var_reset(VTB_WASM_TOP___024root* vlSelf) {
    ...
    vlSelf->TB_WASM_TOP__DOT__read_pointer = VL_RAND_RESET_I(8);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__read_pointer_shift_minusone = VL_RAND_RESET_I(8);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__shift_vld = VL_RAND_RESET_I(1);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__pop_num = VL_RAND_RESET_I(4);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__read_pointer = VL_RAND_RESET_I(8);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__jump_en = VL_RAND_RESET_I(1);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__jump_addr = VL_RAND_RESET_I(8);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__jump_hlt = VL_RAND_RESET_I(1);
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__para_num_reg[__Vi0] = VL_RAND_RESET_I(4);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__retu_num_reg[__Vi0] = VL_RAND_RESET_I(4);
    }
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__function_num_reg = VL_RAND_RESET_I(5);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__function_num_left = VL_RAND_RESET_I(5);
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        VL_RAND_RESET_W(72, vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__function_type_list[__Vi0]);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__function_addr_list[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__start_function_idx = VL_RAND_RESET_I(5);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__global_mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__push_select__out__strong__out38 = VL_RAND_RESET_I(2);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__ALUControl__out__strong__out56 = VL_RAND_RESET_I(5);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__ALUControl__out__strong__out76 = VL_RAND_RESET_I(5);
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_ctrl_unit__DOT__ALUControl__out__strong__out77 = VL_RAND_RESET_I(5);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_instr_mem_ctrl__DOT__read_pointer = VL_RAND_RESET_I(8);
    ...
    vlSelf->TB_WASM_TOP__DOT__u_wasm_top__DOT__u_instr_mem_ctrl__DOT__write_pointer = VL_RAND_RESET_I(8);
