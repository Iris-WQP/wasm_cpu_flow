...
if __name__ == '__main__':
    revise_line_number('test/wat_files/vmm_10000.txt')
    distract_instrs('test/wat_files/bubble.txt', 'wasm_benchmark_file/temp.txt')
    rearrange_file('wasm_benchmark_file/temp.txt', 'test/hex_files/bubble_hex.txt')
