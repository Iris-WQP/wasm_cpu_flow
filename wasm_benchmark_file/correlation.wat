(module
  ...
  (func $_start (export "_start") (type $t6)
    (local $l0 i32) (local $l1 i32) (local $l2 i32) (local $l3 i32) (local $l4 i32) (local $l5 i32) (local $l6 i32) (local $l7 i32) (local $l8 i32) (local $l9 i32) (local $l10 i32) (local $l11 i32) (local $l12 i32) (local $l13 i32) (local $l14 i32) (local $l15 i32) (local $l16 f64) (local $l17 f64)
    (i32.store
      (i32.const 2184)
      (i32.const 2064))
    (i32.store
  ...
  (memory $memory (export "memory") 1024 1024)
  (global $g0 (mut i32) (i32.const 69312))
  (elem $e0 (i32.const 1) func $f6 $f19 $f20 $f21 $f10 $f22 $f31)
  (data $d0 (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00corr\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\b0\06")
